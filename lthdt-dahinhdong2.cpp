...
//DE:
/*
 Bài tập (lthdt-dahinhdong2.cpp): Tính diện tích các hình: Hình tam giác biết 3 cạnh a,b,c; hình chữ nhật biết 2 cạnh a,b; 
 hình tròn biết bán kính r; hình trụ biết bán kính r và chiều cao h.
 Biết rằng hình trụ là một loại hình tròn có bán kính r được kéo dài với chiều cao h. 
 Nhập vào một số hình trong đó cả cả hình tam giác, chữ nhật, tròn, trụ.
 Đưa ra diện tích các hình đã nhập.
 Yêu cầu cài đặt đa hình động; viết một hàm thông thường lựa chọn nhập vào kích thước một hình và trả về  hình đã nhập, một hàm đưa ra diện tích hình truyền vào qua đối số.
*/
